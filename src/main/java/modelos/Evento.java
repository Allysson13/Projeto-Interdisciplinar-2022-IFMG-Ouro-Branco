...
public class Evento {
    ...
    public String toString() {
        ...
        return "Nome dos Convidados: " + this.nomeConvidados + ", Fotografo: " + this.fotografo + ", Duracao: " + this.duracao + ", Data: " + this.data + ", Cenario: " + this.cenario + ", Alimentacao: " + this.alimentacao;
